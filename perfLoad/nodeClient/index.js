...
socket.on('connect', () => {
    ...
    socket.emit('clientAuth', 'fhdfashdfosiad');
    ...
    //Correção do bug que acelera a recepção de dados do cliente no servidor.
...
function cpuAverage() {
    const cpus = os.cpus();
    // get milliseconds in each mode, BUT this number is since reboot
